...
{
    /*
    This method returns the piece's position.
    Arguments:
        None
    Returns:    
        std::pair<int,int>: piece's position
    */
    return m_piece_position;
};

void MovesStacker::change_piece(std::pair<int,int> piece_position)
{
    /*
    This method change the piece's position for the moves stacker.
    Do not change the piece's position in the board, only in the moves stacker.
    Arguments:
        piece_position: new piece's position
    */
